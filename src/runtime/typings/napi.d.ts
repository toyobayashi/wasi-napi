declare type napi_env = Ptr

declare type napi_value = Ptr
declare type napi_ref = Ptr
declare type napi_deferred = Ptr
declare type napi_handle_scope = Ptr
declare type napi_escapable_handle_scope = Ptr

declare type napi_addon_register_func = Ptr

declare type napi_callback_info = Ptr
declare type napi_callback = Ptr
...
declare type napi_finalize = Ptr
